/**
 * Site Timeline — Site-level timeline (all messages across all lots).
 */
import { View, Text, StyleSheet, TouchableOpacity } from 'react-native';
import { useRouter, useLocalSearchParams } from 'expo-router';
import { useSafeAreaInsets } from 'react-native-safe-area-context';

export default function SiteTimelineScreen() {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.heading}>Site Timeline</Text>
        <Text style={styles.subtitle}>
          All messages and events across every lot on this site will appear here.
        </Text>
      </View>
    </View>
  );
