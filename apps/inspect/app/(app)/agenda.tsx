/**
 * Agenda — Site-level schedule / calendar.
 */
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.heading}>Site Schedule</Text>
        <Text style={styles.subtitle}>
          Calendar view with inspections, milestones and deadlines will appear here.
        </Text>
      </View>
    </View>
  );
