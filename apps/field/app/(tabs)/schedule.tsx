/**
 * Schedule — Site-level calendar events for the worker
 *
 * Uses @onsite/agenda: fetchAgendaEvents, AGENDA_EVENT_CONFIG, IMPACT_COLORS.
...
const styles = StyleSheet.create({
  ...
  centered: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#F6F7F9' },
  ...
  dateHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 12, gap: 12 },
  dateBadge: {
    width: 48, height: 48, borderRadius: 12, backgroundColor: '#FFFFFF',
    justifyContent: 'center', alignItems: 'center',
  },
  dateBadgeToday: { backgroundColor: ACCENT },
  dateDay: { fontSize: 18, fontWeight: '700', color: '#101828', lineHeight: 20 },
  dateDayToday: { color: '#FFFFFF' },
  dateMonth: { fontSize: 11, color: '#6B7280', fontWeight: '500', textTransform: 'uppercase' },
  dateMonthToday: { color: 'rgba(255,255,255,0.8)' },
  dateInfo: { flex: 1 },
  dateName: { fontSize: 16, fontWeight: '600', color: '#101828' },
  dateCount: { fontSize: 13, color: '#6B7280' },
  eventCard: {
    flexDirection: 'row', backgroundColor: '#FFFFFF', borderRadius: 12,
    padding: 14, marginBottom: 8, gap: 12,
  },
  eventIconBg: { width: 40, height: 40, borderRadius: 10, justifyContent: 'center', alignItems: 'center' },
  eventContent: { flex: 1 },
  eventTitle: { fontSize: 15, fontWeight: '600', color: '#101828', marginBottom: 2 },
  eventDesc: { fontSize: 13, color: '#6B7280', marginBottom: 6, lineHeight: 18 },
  ...
  delayText: { fontSize: 12, color: '#EF4444', fontWeight: '500' },
  emptyContainer: { justifyContent: 'center', alignItems: 'center', paddingVertical: 80, paddingHorizontal: 40 },
  emptyTitle: { fontSize: 20, fontWeight: '600', color: '#101828', marginTop: 16, marginBottom: 8 },
