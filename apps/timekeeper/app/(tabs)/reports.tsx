                  ...
                  return (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        isWeekend && !dateRangeMode && reportStyles.monthDayWeekend,
                        isTodayDate && !dateRangeMode && reportStyles.monthDayToday,
                        hasSessions && !dateRangeMode && reportStyles.monthDayHasData,
                        // Date range styles (Airbnb style)
                    ...
                    >
                      <Text style={[
                        ...
                        isTodayDate && !dateRangeMode && reportStyles.monthDayNumToday,
        ...
        <View style={reportStyles.exportModalOverlay}>
          <View style={reportStyles.exportModalContent}>
            ...
            <View style={reportStyles.exportModalActions}>
              ...
              <TouchableOpacity
                style={reportStyles.exportModalBtn}
                onPress={handleExportPDF}
              >
                <Ionicons name="document-text-outline" size={20} color={colors.white} />
                <Text style={reportStyles.exportModalBtnText}>Export PDF</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
